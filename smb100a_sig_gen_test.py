...
class setupSigGenTest(TestCase):
    def initSigGenTest(self, initSigGen.sig_gen_id, set_state):
        self.assertEqual(initSigGen.sig_gen_id, 'Rohde&Schwarz,SMB100A,1406.6000k02/102027,3.1.19.15-3.20.390.24 \n')
        self.assertFalse(initSigGen.set_state, 0)
